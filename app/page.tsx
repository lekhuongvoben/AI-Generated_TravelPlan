          ...
          <div className="flex flex col sm:items-start sm:text-left m-4 gap-4">
           {/* Location Input */}
                <div className="flex items-center gap-3 flex-1 border border-gray-200 rounded-xl px-4 py-3">
                    ...
                    <input type="text" placeholder="Where do you want to go?"className="w-full outline-none text-gray-700 placeholder-gray-700"/>
                </div> 
            {/* Date Input */}
                {/* <div className="flex items-center gap-3 flex-1 border border-gray-200 rounded-xl px-4 py-3"> */}
                <div>
                    ...
                    <input type="dateRange" placeholder="Select dates" className="w-full outline-none text-gray-700 placeholder-gray-400"/>
