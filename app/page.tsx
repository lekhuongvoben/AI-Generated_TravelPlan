          ...
          <div className="flex flex col sm:items-start sm:text-left m-4 gap-4">
           {/* Location Input */}
                <div className="flex items-center gap-3 flex-1 border border-gray-200 rounded-xl px-4 py-3">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8c0 7-7.5 12-7.5 12S4.5 15 4.5 8a7.5 7.5 0 1115 0z"/>
                    </svg>
            ...
            {/* Date Input */}
                <div className="flex items-center gap-3 flex-1 border border-gray-200 rounded-xl px-4 py-3">
                    ...
                    <input type="text" placeholder="Select dates" className="w-full outline-none text-gray-700 placeholder-gray-400"/>
                </div>
            {/* Explore Button */}
